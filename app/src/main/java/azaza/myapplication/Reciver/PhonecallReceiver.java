    ...
    public void onCallStateChanged(Context context, int state, String number) {
        ...
        switch (state) {
            case TelephonyManager.CALL_STATE_RINGING:
                isIncoming = true;
                callStartTime = new CurDate().getDate();
                savedNumber = number;
            ...
            case TelephonyManager.CALL_STATE_IDLE:
                ...
                if(lastState == TelephonyManager.CALL_STATE_RINGING){
                    ...
                    onIncomingCallEnded(context, savedNumber, callStartTime, new CurDate().getDate());
                }
                else{
                    onOutgoingCallEnded(context, savedNumber, callStartTime, new CurDate().getDate());
                }
                break;
        }
        lastState = state;

...
public class DataBaseProvider extends ContentProvider {
    ...
    public void addRec(Context ctx, String myType, String number, String contact, String date, String text, long alarmdate) {
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            ContentValues cv = new ContentValues();
            for (int i = 1; i <= 3; i++) {
                cv.put(COLUMN_TYPE, "1");
                cv.put(COLUMN_NUBMER, "2222");
                cv.put(COLUMN_CONTACT, "azaza");
                cv.put(COLUMN_DATE, "12.12.2015");
                cv.put(COLUMN_TXT, "asdsad");
                cv.put(COLUMN_ALARMDATE, "12321321321");

package azaza.myapplication.Libs.Spinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.abc_action_bar_content_inset_material);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(R.dimen.abc_text_size_headline_material),
        ...
        int resId = typedArray.getColor(R.color.abc_background_cache_hint_selector_material_dark, -1);
